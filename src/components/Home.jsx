        ...
        <div className="home container" onMouseMove={handleMouseMove}>
          <section className="Me_center">
            ...
            <h1 className="heading">
              Suniel <strong className="strong">Sharma</strong>{" "}
            </h1>
            <p className="subPara">
              "Full-stack Devs Craft <strong> Digital</strong> Experiences."{" "}
            </p>
              ...
              <img
                ...
                style={{
                  ...
                  transform: `translate(-${mousePosition.x / 20}px, ${
                    mousePosition.y / 20
                  }px)`, // Adjust the divisor for the desired effect
                }}
              />
